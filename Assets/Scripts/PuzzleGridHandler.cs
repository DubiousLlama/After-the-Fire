 ...
 * void setTile(int x, int y, GameObject tile) - sets the tile at the specified position to the specified tile
 * int calculateManaAtPosition(int i, int j) - calculates the mana generated by the plant at the specified position
 * int calculateMana() - calculates the total mana generated by all plants on the grid
 * int countType(string plant) - counts the number of plants of the specified type on the grid
 * bool place (string content) - places a plant of the specified type at the player's current position
 * void placeAbsolute(int x, int y, string content) - places a plant of the specified type at the specified position
 * string GetContent(int x, int y) - returns the type of plant at the specified position
 * Vector2 PositionToTile(Vector3 position) - converts the player's position to a tile on the grid
 * void Cleanup() - destroys all children of the grid
 */
...
namespace GridHandler
{
    ...
    public class PuzzleGridHandler : MonoBehaviour
    {
        ...
        // Calculates the mana generated by the plant at the specified position
        ...
        // Counts the number of plants of the specified type on the grid
        ...
        public bool Place(string content)
        {
            ...
            if (CheckFull() && CalculateMana() < manaRequired)
                dialogue.PlayMessage("Oops, this isn't quite right 0 ^ 0");
        ...
        // Destroys all children of the grid
        public void Cleanup()
        {
        ...
        // DEBUGGING: Runs a test to check that the grid initializes correctly and that the CalculateMana function works
        ...
        // Instantiate a plant at the specified position
